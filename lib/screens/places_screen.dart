    ...
    return FutureBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('Error al cargar las localizaciones cercanas'));
          } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(child: Text('No se encontraron localizaciones cercanas'));
        } else {
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String locationImg = 'https://turismolanzarote.com/wp-content/uploads/2017/03/Playas-PlayaBlanca-PlayaFlamingo-LR-3.jpg';
                getPhotosForLocation(locationId).then((value) => {
                    locationImg = value[0]
                });
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: NetworkImage(locationImg), // Cambiar esto por la imagen real
                        fit: BoxFit.cover,
                      ),
                    ),
                    child: Center(
